...
import poli.meets.coreservice.service.TeachingAssistantService;
...
/**
 * REST controller for managing {@link poli.meets.coreservice.domain.TeachingAssistant}.
 */
@Slf4j
@RestController
@RequestMapping("/api")
...
public class TeachingAssistantResource {
    ...
    public ResponseEntity<TeachingAssistantDTO> createTeachingAssistant(@RequestBody TeachingAssistantDTO teachingAssistantDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/teaching-assistants/" + result.getId()))
            .body(result);
    }
